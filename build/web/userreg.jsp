    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>Registration</h2>
         <hr><br>
          <form action="userregact.jsp" method="post" id="" enctype="multipart/form-data">
          ...
          <label for="category">Enter category </label>
            ...
            <select id="s1" name="category"  class="text">
              <option>--Select--</option>
              <option>Android </option>
              <option>Java</option>
              <option>Hadoop</option>
              <option>Main Frames</option>
          ...
          <label for="location"></label>
            ...
            <label for="pic">Select Profile</label>
