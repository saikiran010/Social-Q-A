    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <p class="infopost">&nbsp;</p>
          <form action="topuseract2.jsp" method="post">
               <%
               
                        String category = request.getParameter("category");
                              		
			String sql="SELECT question FROM questions where category = '"+category+"'  ";
			...
			%>
                        ...
                        <input id="category" readonly="" name="category" value="<%=category%>" size="3"  class="text" />
                        <br><br>
                    
                         <label for="gender">Select Questions </label>
          
                         <select id="category" name="question"  class="text" >
